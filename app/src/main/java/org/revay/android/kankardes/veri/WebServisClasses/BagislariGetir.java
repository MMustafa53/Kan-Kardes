...
public class BagislariGetir extends AsyncTask<Void, Void, Veri[]> {
    ...
    public BagislariGetir(AppCompatActivity activity){
    ...
    protected Veri[] doInBackground(Void... voids) {
        ...
        try {
            ...
            URL url = new URL("https://"+ context.getString(R.string.siteUrl) +"/"+ context.getString(R.string.sitePath) +"/bagis_istekleri.php");
