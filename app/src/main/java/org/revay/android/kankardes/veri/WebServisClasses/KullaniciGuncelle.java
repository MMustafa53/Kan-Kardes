...
public class KullaniciGuncelle extends AsyncTask<Void, Void, Void> {
    private StringBuilder sb = new StringBuilder();
    private WeakReference<PreferenceFragmentCompat> weakReference;

    public KullaniciGuncelle(PreferenceFragmentCompat activity){
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            URL url = new URL("https://"+ context.getString(R.string.siteUrl) +"/"+ context.getString(R.string.sitePath) +"/kullanici_guncelle.php");
    ...
    private WeakReference<PreferenceFragmentCompat> getWeakReference() {
        return weakReference;
    }

    private void setWeakReference(WeakReference<PreferenceFragmentCompat> weakReference) {
